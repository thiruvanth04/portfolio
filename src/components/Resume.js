        ...
        <section id='resume' className='flex flex-col md:flex-row bg-secondary px-5'>
            ...
            <div className='md:w-1/2 flex justify-center'>
                <div className='flex flex-col justify-center text-white'>
                    ...
                    <a className='btn2' href='https://drive.google.com/file/d/1QCZB6H_aK07OaihYo6I12Y8ymzTKkJHl/view?usp=sharing' target='_blank' rel='noopener noreferrer'> Download</a>
                </div>
            </div>
        </section>
    );
